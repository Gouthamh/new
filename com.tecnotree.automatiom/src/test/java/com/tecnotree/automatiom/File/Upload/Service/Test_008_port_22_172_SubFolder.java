...
public class Test_008_port_22_172_SubFolder {
	
	@BeforeClass
	public void masterDataUpdate() throws JsonProcessingException {
		MasterFiledServiceConfigure master = new MasterFiledServiceConfigure(ServiceName.localHost_22,8,"SFTP",5000,new FileUpload("9367",500,"/home/tecnotree/"));
...
@Test(groups = "JSON")
	...
	DiffsentsFiles.differentMethods1("JSON.json",ServiceName.localHost_22,"BulkStorage");


	}
	@Test(groups = "SQL")
	public void SQl() throws InterruptedException, IOException {
		DiffsentsFiles.differentMethods1("1-DDL_DML-script+(School+DB).sql",ServiceName.localHost_22,"BulkStorage");
	}
	@Test	(groups = "TAR")
	public void tar() throws InterruptedException, IOException {
		DiffsentsFiles.differentMethods1("apache-maven-3.9.2-bin.tar",ServiceName.localHost_22,"BulkStorage");
	}
	@Test(groups = "BPMN")
	public void BPMN() throws InterruptedException, IOException {
		DiffsentsFiles.differentMethods1("BPMN.bpmn",ServiceName.localHost_22,"BulkStorage");
	}
	@Test(groups = "YMAL")
	public void YMAL() throws InterruptedException, IOException {
		DiffsentsFiles.differentMethods1("dap-kafka-producer-service.yaml", ServiceName.localHost_22,"BulkStorage");
	}
	@Test(groups = "DMN")
	public void DMN() throws InterruptedException, IOException {
		DiffsentsFiles.differentMethods1("DMN.dmn",ServiceName.localHost_22,"BulkStorage");
	}
	@Test(groups = "JPG")
	public void JPG() throws InterruptedException, IOException {
		DiffsentsFiles.differentMethods1("HD-wallpaper-thar-car-wagon-wrangler.jpg",ServiceName.localHost_22,"BulkStorage");
	}
	@Test(groups = "HTML")
	public void HTML() throws InterruptedException, IOException {
		DiffsentsFiles.differentMethods1("mongotemplate_1713176840471.html",ServiceName.localHost_22,"BulkStorage");
	}
	@Test(groups = "XLX")
	public void XLX() throws InterruptedException, IOException {
		DiffsentsFiles.differentMethods1("oracel54672913644.xls",ServiceName.localHost_22,"BulkStorage");
	}
	@Test(groups = "CSV")
	public void CSV() throws InterruptedException, IOException {
		DiffsentsFiles.differentMethods1("oracel83510302348.csv",ServiceName.localHost_22,"BulkStorage");
	}
	@Test(groups = "TXT")
	public void TXT() throws InterruptedException, IOException {
		DiffsentsFiles.differentMethods1("oracel901701790.txt",ServiceName.localHost_22,"BulkStorage");
	}
	@Test(groups = "JPEG")
	public void JPEG() throws InterruptedException, IOException {
		DiffsentsFiles.differentMethods1("Sample-JPEG-file-download-for-Testing.JPEG",ServiceName.localHost_22,"BulkStorage");
	}
	@Test(groups = "PNG")
	public void PNG() throws InterruptedException, IOException {
		DiffsentsFiles.differentMethods1("vi.png",ServiceName.localHost_22,"BulkStorage");
	}
	@Test(groups = "ZIP")
	public void ZIP() throws InterruptedException, IOException {
		DiffsentsFiles.differentMethods1("ZIP.zip",ServiceName.localHost_22,"BulkStorage");
	}
	@Test(groups = "SevenZFile")
	public void SevenZFile() throws InterruptedException, IOException {
		DiffsentsFiles.differentMethods1("7z.7z",ServiceName.localHost_22,"BulkStorage");
	}
}
